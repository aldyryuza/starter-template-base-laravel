                ...
                <div class="card-body border-top">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-3">
                                <input type="text" name="id" id="id" value="{{ $data['id'] ?? null }}"
                                    hidden>
                                <label for="type" class="form-label">Subsidiary</label>
                                <input type="text" class="form-control required" id="type" error="Subsidiary"
                                    placeholder="Enter subsidiary" value="{{ $data['type'] ?? null }}" />
                            </div>
                            <div class="mb-3">
                        ...
                        @if (isset($data['code']))
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-3">
                                    <label for="code" class="form-label">Subsidiary code</label>
                                    <input type="text" class="form-control required" id="code"
                                        error="Subsidiary code" placeholder="Enter subsidiary code"
                ...
                <div class="p-3 border-top">
                    <div class="text-end">
                        @if ($data_page['action'] != 'detail')
                            <button type="button" class="btn btn-primary" onclick="Subsidiary.submit()">
                                Save
                            </button>
                        @endif
                        <button type="button" class="btn bg-danger-subtle text-danger ms-6 px-4"
                            onclick="Subsidiary.back()">
                            Cancel
                        </button>
                    </div>
                </div>
