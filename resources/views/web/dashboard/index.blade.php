...
<div class="owl-carousel counter-carousel owl-theme">
        ...
        <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
            <div class="card-body">
                <div class="text-center">
                    <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-user-male.svg"
    ...
    <div class="item">
        <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
            <div class="card-body">
                <div class="text-center">
                    <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-favorites.svg"
                        width="50" height="50" class="mb-3" alt="modernize-img" />
    ...
    <div class="item">
        <div class="card border-0 zoom-in bg-info-subtle shadow-none">
            <div class="card-body">
                <div class="text-center">
                    <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-connect.svg"
                        width="50" height="50" class="mb-3" alt="modernize-img" />
                    ...
                    <div class="col-md-4">
                        <div class="hstack mb-4 pb-1">
                            <div
                                ...
                                <i class="bx bx-grid-dots text-primary fs-6"></i>
                            </div>
                            <div>
                    ...
                    <div class="col-8">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <span
                                ...
                                <i class="bx bx-arrow-up-left text-success"></i>
                            </span>
                    ...
                    <div class="col-8">
                        ...
                        <div class="d-flex align-items-center pb-1">
                            <span
                                ...
                                <i class="bx bx-arrow-down-right text-danger"></i>
                            </span>
                            <p class="text-dark me-1 fs-3 mb-0">+9%</p>
                            <p class="fs-3 mb-0">last year</p>
                        </div>
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-end">
                            <div
                                ...
                                <i class="bx bx-currency-dollar fs-6"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <div
                                ...
                                <i class="bx bx-grid-dots text-muted fs-6"></i>
                            </div>
                            <div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-7 pb-2">
                    <div class="me-3 pe-1">
                        <img src="../assets/images/profile/user-2.jpg" class="shadow-warning rounded-2"
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="javascript:void(0)"
                        ...
                        <i class="bx bx-message-2 fs-6 text-primary"></i>
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-7">
                        <div class="d-flex">
                            <div
                                ...
                                <i class="bx bx-grid-dots text-success fs-6"></i>
                            </div>
                            <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex">
                            <div
                                ...
                                <i class="bx bx-grid-dots text-danger fs-6"></i>
                            </div>
                            <div>
